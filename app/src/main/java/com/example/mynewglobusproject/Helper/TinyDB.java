...
package com.example.mynewglobusproject.Helper;
...
import com.example.mynewglobusproject.model.ItemsModel;
...
public class TinyDB {
    ...
    public String putImage(String theFolder, String theImageName, Bitmap theBitmap) {
        if (theFolder == null || theImageName == null || theBitmap == null) {
            Log.e("TinyDB", "Invalid parameters: folder, image name, and bitmap must not be null");
            return null;
        }
        ...
        if (!mFullPath.isEmpty()) {
            ...
            if (saveBitmap(mFullPath, theBitmap)) {
                return mFullPath;
            }
        }
        return null;
